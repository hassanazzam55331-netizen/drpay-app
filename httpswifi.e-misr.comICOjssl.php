...
{
"rex": "style=\"width:45%;display:inline-block;\"
onkeyup=\"pvsa.value=Math.round((avsa.value*1.4286)*100)/100;_('movoPayVSA').innerHTML=Math.ceil(avsa.value*1.5);\"
step=\"0.5\" min=\"3\" max=\"500\" required",
"name": "avsa",
"type": "number",
"title": "الرصيد"
},
{
"rex": "style=\"width:45%;display:inline-block;\"
onkeyup=\"avsa.value=Math.round(pvsa.value*0.70);_('movoPayVSA').innerHTML=Math.ceil(avsa.value*1.5);\"
onblur=\"pvsa.value=Math.round((avsa.value*1.4286)*100)/100;_('movoPayVSA').innerHTML=Math.ceil(avsa.value*1.5);\"
step=\"0.01\"",
"name": "pvsa",
"type": "number",
"title": "المدفوع"
...
"inf": "\u003Ctable\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eخدمة
العملاء\u003C/td\u003E\u003Ctd\u003E888\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة رقم
الخط\u003C/td\u003E\u003Ctd\u003E*878#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة
الرصيد\u003C/td\u003E\u003Ctd\u003E*60#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eلمعرفة قيمة
سلفني\u003C/td\u003E\u003Ctd\u003E*60*0#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eلمعرفة تفاصيل
سلفني\u003C/td\u003E\u003Ctd\u003E*3*5#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eباقات
الانترنت\u003C/td\u003E\u003Ctd\u003E*2000#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eباقات
المكالمات\u003C/td\u003E\u003Ctd\u003E*880#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eتجديد باقات
المكالمات\u003C/td\u003E\u003Ctd\u003E*225#\u003C/td\u003E\u003C/tr\u003E\r\n\u003C/table\u003E"
},
"s2": {
"id": "2",
"sid": "1",
...
{
"rex": "style=\"width:45%;display:inline-block;\"
onkeyup=\"pvsa.value=Math.round((avsa.value*1.4286)*100)/100;_('moetPayVSA').innerHTML=Math.ceil(avsa.value*1.5);\"
step=\"1\" min=\"5\" max=\"200\" required",
"name": "avsa",
"type": "number",
"title": "الرصيد"
},
{
"rex": "style=\"width:45%;display:inline-block;\"
onkeyup=\"avsa.value=Math.round(pvsa.value*0.70);_('moetPayVSA').innerHTML=Math.ceil(avsa.value*1.5);\"
onblur=\"pvsa.value=Math.round((avsa.value*1.4286)*100)/100;_('moetPayVSA').innerHTML=Math.ceil(avsa.value*1.5);\"
step=\"0.01\"",
"name": "pvsa",
"type": "number",
"title": "المدفوع"
...
"inf": "\u003Ctable\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eخدمة
العملاء\u003C/td\u003E\u003Ctd\u003E333\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة رقم
الخط\u003C/td\u003E\u003Ctd\u003E*947#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة
الرصيد\u003C/td\u003E\u003Ctd\u003E*555#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة
السلف\u003C/td\u003E\u003Ctd\u003E*2002#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eتجديد باقات
المكالمات\u003C/td\u003E\u003Ctd\u003E*807#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة
الاستهلاك\u003C/td\u003E\u003Ctd\u003E*838#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eتغير
النظام\u003C/td\u003E\u003Ctd\u003E525\u003C/td\u003E\u003C/tr\u003E\r\n\u003C/table\u003E"
},
"s3": {
"id": "3",
"sid": "1",
...
{
"rex": "style=\"width:45%;display:inline-block;\"
onkeyup=\"pvsa.value=Math.round((avsa.value*1.43)*100)/100;_('moorPayVSA').innerHTML=Math.ceil(avsa.value*1.5);\"
step=\"0.5\" min=\"3.5\" max=\"349\" required",
"name": "avsa",
"type": "number",
"title": "الرصيد"
},
{
"rex": "style=\"width:45%;display:inline-block;\"
onkeyup=\"avsa.value=Math.round(pvsa.value*0.70);_('moorPayVSA').innerHTML=Math.ceil(avsa.value*1.5);\"
onblur=\"pvsa.value=Math.round((avsa.value*1.43)*100)/100;_('moorPayVSA').innerHTML=Math.ceil(avsa.value*1.5);\"
step=\"0.01\"",
"name": "pvsa",
"type": "number",
"title": "المدفوع"
...
"inf": "\u003Ctable\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eخدمة
العملاء\u003C/td\u003E\u003Ctd\u003E110\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة رقم
الخط\u003C/td\u003E\u003Ctd\u003E#119*1#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة
الرصيد\u003C/td\u003E\u003Ctd\u003E#100*111#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة
الاستهلاك\u003C/td\u003E\u003Ctd\u003E#0#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eتجديد
الباقة\u003C/td\u003E\u003Ctd\u003E#0#\u003C/td\u003E\u003C/tr\u003E\r\n\u003C/table\u003E"
},
"s4": {
"id": "4",
"sid": "1",
...
{
"rex": "style=\"width:45%;display:inline-block;\"
onkeyup=\"avsa.value=Math.ceil(Math.round((pvsa.value*1.4286)*100/100));_('mowePayVSA').innerHTML=Math.ceil(pvsa.value*1.5);\"
onblur=\"pvsa.value=Math.round((avsa.value*0.70)*100)/100;_('mowePayVSA').innerHTML=Math.ceil(pvsa.value*1.5);\"
step=\"0.01\" min=\"3.5\" max=\"200\" required",
"name": "pvsa",
"type": "number",
"title": "الرصيد"
},
{
"rex": "style=\"width:45%;display:inline-block;\"
onkeyup=\"pvsa.value=Math.round((avsa.value*0.70)*100)/100;_('mowePayVSA').innerHTML=Math.ceil(pvsa.value*1.5);\"
step=\"0.01\"",
"name": "avsa",
"type": "number",
"title": "المدفوع"
...
"inf": "\u003Ctable\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eخدمة
العملاء\u003C/td\u003E\u003Ctd\u003E111\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة رقم
الخط\u003C/td\u003E\u003Ctd\u003E*688#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eمعرفة
الرصيد\u003C/td\u003E\u003Ctd\u003E*414#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eباقات
الانترنت\u003C/td\u003E\u003Ctd\u003E*999#\u003C/td\u003E\u003C/tr\u003E\r\n\u003Ctr\u003E\u003Ctd\u003Eتجديد
الباقة\u003C/td\u003E\u003Ctd\u003E*600*2#\u003C/td\u003E\u003C/tr\u003E\r\n\u003C/table\u003E"
},
"s5": {
"id": "5",
"sid": "3",
...
"lst": [
{
"title": "ذكاة عيد الفطر المبارك",
"value": "35"
},
{
"cut": "770",
"vsa": "770",
"title": "كرتونة رمضان كبيرة",
"value": "770"
},
{
"cut": "505",
"vsa": "505",
"title": "كرتونة رمضان وسط",
"value": "505"
},
{
"cut": "350",
"vsa": "350",
"title": "كرتونة رمضان صغيرة",
"value": "350"
},
{
"title": "ادعم غزة",
...
"inf": "اورنج كاش - فودافون كاش - اتصالات فلوس - وي باي - جميع المحافظ الذكية لجميع البنوك\u003Chr\u003Eمتاح من 1ج الي
60 الف جنيه للعمليه الواحده"
},
"s814": {
"id": "814",
"sid": "21",
