            ...
            placeOrder: function (data) {
                ...
                "<table class='table table-hover table-fixed'>" +
                  ...
                  "<th class='col-xs-2'>Discount</th>" +
                    ...
                    "<th class='col-xs-3'>Net Amount</th>" +
                  "</tr>" +
                  "</thead>"
                "<tbody>";
                for (var i = 0; i < items.length; i++) {
                  html +=
                    "<tr>" +
                    "<td class='col-xs-1'>" + items[i].product_id + "</td>" +
                    "<td class='col-xs-3'>" + items[i].name + "</td>" +
                    "<td class='col-xs-2'>" + items[i].base_price + "</td>" +
                    "<td class='col-xs-2'>" + items[i].discount_amount + "</td>" +
                    "<td class='col-xs-1'>" + items[i].qty + "</td>" +
                    "<td class='col-xs-3'>" + (items[i].base_row_total-items[i].base_discount_amount) + "</td>" +
                    "</tr>";

                }
                document.getElementById("cartTable").innerHTML += html+"</tbody></table>";
                ...
                jQuery.ajax({
                        ...
                        success: function(result){
                            ...
                            jQuery("#pCustomerName").text(FullName);
                            ...
                            function yourFunction(){
                                ...
                                $.get("https://connectpay.com.pk:557/cpay/gos?userName=bareezeman&password=p@ssw0rd&cpayId="+connectPayId+"", function(data){
